(function( $ , api){
    ...
    api.section( 'supreme_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'supreme_about_section' , function( section ){
    ...
    api.section( 'supreme_blog_section' , function( section ){
    ...
    api.section( 'supreme_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-supreme_contact_custom_formshortcode'),
                selector = $('#_customize-input-supreme_contact_formshortcode');
    ...
    // General section
    api.section( 'supreme_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#supreme_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-supreme_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-supreme_preloader_color' );
            ...
            var $backtotop          = $( '#supreme_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-supreme_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-supreme_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'supreme_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#supreme_footer_widget_toggle');
