...
// image default alt
if( !function_exists( 'supreme_img_default_alt' ) ){
	function supreme_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'supreme_img_tag' ) ){
	function supreme_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = supreme_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'supreme_anchor_tag' ) ){
	function supreme_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'supreme_heading_tag' ) ){
	function supreme_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'supreme_paragraph_tag' ) ){
	function supreme_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'supreme_other_tag' ) ){
	function supreme_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'supreme_button_element ' ) ){
	function supreme_button_element( array $args ){
