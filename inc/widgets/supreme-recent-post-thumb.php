...
class supreme_recent_widget extends WP_Widget {
...
'supreme_recent_widget',


// Widget name will appear in UI
esc_html__( '[ supreme ] Recent Post', 'supreme' ),

// Widget description
array( 'description' => esc_html__( 'Add recent post with thumbnail', 'supreme' ), )
);
		...
		while( $loop->have_posts() ){
			...
			if( has_post_thumbnail() ):
				...
				<div class="media post_item">
					<?php
					the_post_thumbnail( 'supreme_widget_post_thumb', array( 'class' => 'img-fluid' ) ); ?>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Recent Post', 'supreme' );
}
//	
...
<p>
<label for="<?php echo $this->get_field_id( 'post_number' ); ?>"><?php _e( 'Posts Number:' ,'supreme'); ?></label>
...
} // Class supreme_recent_widget ends here


// Register and load the widget
function supreme_recent_post_load_widget() {
	register_widget( 'supreme_recent_widget' );
}
add_action( 'widgets_init', 'supreme_recent_post_load_widget' );