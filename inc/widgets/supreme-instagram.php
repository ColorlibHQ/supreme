...
----------------------------------------*/
class supreme_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('supreme_instagram_photo',esc_html__('[ Supreme ] Intagram Photo','supreme'),array(
			'description' => esc_html__('Supreme Instagram Photo Widget','supreme'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'supreme');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'supreme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'supreme'); ?></label>
...
if(!function_exists('supreme_instagram_widgets')):
	function supreme_instagram_widgets(){
		register_widget('supreme_instagram_photo');
	}
	add_action('widgets_init','supreme_instagram_widgets');
endif;
