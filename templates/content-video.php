...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-video'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  supreme_blog_posts_meta
		 *
		 * @Hooked supreme_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'supreme_blog_posts_meta' );
		 ...
		 * @Hook  supreme_blog_posts_excerpt
		 *
		 * @Hooked supreme_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'supreme_blog_posts_excerpt' );
