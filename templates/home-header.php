    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = supreme_opt( 'supreme_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo supreme_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( supreme_featured_post_cat() ){
                                echo '<span class="entry__category">'.supreme_featured_post_cat().'</span>';
                            }
                            ?>
